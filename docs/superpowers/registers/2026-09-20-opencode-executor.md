...
| 5 | Lane-eligible warning stays off for inline plans though SP-A makes it meaningful | - | plan-lint warns on an eligible task in an inline plan | open | Deferred in SP-A 2026-09-20: turning it on changes a pinned fixture for an advisory warning |
