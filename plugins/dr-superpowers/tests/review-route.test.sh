...
present "the Claude manifest is 1.18.0" "$P/.claude-plugin/plugin.json" '"version": "1.18.0"'
present "the Codex manifest is 1.18.0" "$P/.codex-plugin/plugin.json" '"version": "1.18.0"'
