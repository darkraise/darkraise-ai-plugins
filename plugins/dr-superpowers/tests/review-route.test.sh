...
present "the Claude manifest is 1.13.0" "$P/.claude-plugin/plugin.json" '"version": "1.13.0"'
present "the Codex manifest is 1.13.0" "$P/.codex-plugin/plugin.json" '"version": "1.13.0"'
