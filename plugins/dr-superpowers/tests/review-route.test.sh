...
present "the Claude manifest is 1.16.1" "$P/.claude-plugin/plugin.json" '"version": "1.16.1"'
present "the Codex manifest is 1.16.1" "$P/.codex-plugin/plugin.json" '"version": "1.16.1"'
