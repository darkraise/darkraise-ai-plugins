...
present "the Claude manifest is 1.14.0" "$P/.claude-plugin/plugin.json" '"version": "1.14.0"'
present "the Codex manifest is 1.14.0" "$P/.codex-plugin/plugin.json" '"version": "1.14.0"'
...
present "the budget checkpoints finish the task in flight" "$P/reference/session-budget.md" 'finish the task in flight through its'
