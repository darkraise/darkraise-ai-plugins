...
description: "Task implementer running Sonnet 5 at medium effort. Dispatched by dr-superpowers for score 2: small well-specified changes with light coupling."
model: sonnet
effort: medium
skills:
