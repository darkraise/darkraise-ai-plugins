...
Subagent ([JUDGE]):
  ...
  prompt: |
    ...
    **Diff file:** [DIFF_FILE]
    ...
    mid-function — and say so in your report. Do not run git commands: you
    have no shell. If the diff file is missing, stop and report that the
    controller must pass one.
