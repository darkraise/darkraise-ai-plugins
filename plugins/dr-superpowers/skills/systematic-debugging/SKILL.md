...
1. **Create Failing Test Case**
   ...
   - Use the `dr-superpowers:test-driven-development` skill for writing proper failing tests
...
3. **Verify Fix**
   ...
   - Use the `dr-superpowers:verification-before-completion` skill before claiming success
