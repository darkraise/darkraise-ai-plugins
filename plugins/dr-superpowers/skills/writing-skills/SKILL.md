...
**Personal skills live in your runtime's skills directory** (`~/.claude/skills/` on Claude Code; Codex also recognizes `~/.agents/skills/` as a cross-runtime alias).
...
- ✅ Good: `**REQUIRED SUB-SKILL:** Use dr-superpowers:test-driven-development`
- ✅ Good: `**REQUIRED BACKGROUND:** You MUST understand dr-superpowers:systematic-debugging`
...
**REQUIRED BACKGROUND:** The dr-superpowers:test-driven-development skill explains why this matters. Same principles apply to documentation.
